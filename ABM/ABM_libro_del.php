...
<body>
    ...
    <div class="bg-warning py-4">
        <div class="container text-center">
            ...
            <p class="fs-5 text-purple-dark">Procesando solicitud de eliminación de libro</p>
        </div>
    </div>
        ...
        <div class="result-container">
            ...
            if (!$confirmado) {
                ...
                echo '<div class="confirmation-container">
                        ...
                        <p class="fs-5 fw-bold">¿Estás seguro de que quieres eliminar este libro?</p>
                ...
                echo '<div class="book-info">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8 text-start">
                                ...
                                <p class="mb-1"><strong>Clasificación:</strong> ' . htmlspecialchars($libro['clasificacion']) . '</p>
                                <p class="mb-0"><strong>Color:</strong> ' . htmlspecialchars($libro['color']) . '</p>
                            </div>
                        </div>
                      </div>';
                ...
                echo '<div class="text-center">
                        <a href="./ABM_libro.php" class="btn btn-outline-secondary btn-action">
                            <i class="fas fa-times me-2"></i>
                            Cancelar
                        </a>
                        <a href="./ABM_libro_del.php?id=' . $libro_id . '&confirmar=si" class="btn btn-danger btn-action">
                ...
                if ($stmt->execute()) {
                    if ($stmt->affected_rows > 0) {
                        echo '<div class="success-message">
                                ...
                                <h3>¡Libro Eliminado Exitosamente!</h3>
                        ...
                        echo '<a href="./ABM_libro_añadir.html" class="btn btn-outline-success btn-action">Añadir Nuevo Libro</a>';
                    ...
                    echo '<a href="./ABM_libro.php" class="btn btn-purple btn-action">Volver a la Lista</a>';
                    echo '<a href="./ABM_libro_del.php?id=' . $libro_id . '" class="btn btn-outline-danger btn-action">Intentar de Nuevo</a>';
                }
